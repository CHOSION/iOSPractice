...
class StarViewController: UIViewController {
    ...
    private func loadStarDiaryList() {
        ...
        self.diaryList = data.compactMap {
            ...
            guard let date = $0["date"] as? Bool else { return nil }
...
extension StarViewController: UICollectionViewDelegateLayout{
...
extension StarViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard let viewController = self.storyboard?.instantiateViewController(withIdentifier: "DetailDiaryViewController") as? DetailDiaryViewController else { return }
        let diary = self.diaryList[indexPath.row]
